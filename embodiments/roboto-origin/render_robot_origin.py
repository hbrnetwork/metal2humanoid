"""
Render Atom01 Robot using MuJoCo's native viewer
"""
import mujoco
import mujoco.viewer
import numpy as np

# Load the Atom01 robot model (using MuJoCo XML format)
model = mujoco.MjModel.from_xml_path('embodiments/roboto-origin/xmls/atom01_torso.xml')
data = mujoco.MjData(model)

# Set initial pose at a good height
# Adjust base height for standing pose
